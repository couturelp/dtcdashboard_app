const FEATURES = [
  {
    ...
    description:
      'See revenue, COGS, shipping, fees, ad spend, and net profit in one view. Track gross, contribution, and net profit with period-over-period comparison.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description:
      'Campaign-level performance across Meta Ads and Google Ads. ROAS, CPC, CPM, CTR, and CPA at a glance with drill-down to ad set and ad level data.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description:
      'Upload your COGS via CSV or enter them manually. Configure shipping rates, track operating expenses, and manage custom cost categories.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description:
      'Connect Shopify, Meta Ads, Google Ads, and Google Analytics through Fivetran. Your data syncs automatically so your numbers are always current.',
  },
];
